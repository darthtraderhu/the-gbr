    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#e7ff00] selection:text-black overflow-hidden relative cursor-default font-sans">
      ...
      <section className="relative z-10 w-full pt-32 pb-16 lg:pt-48 lg:pb-24 flex flex-col items-center text-center">
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          ...
          <p className="max-w-4xl text-lg md:text-xl lg:text-2xl text-gray-400 mb-8 leading-relaxed font-medium border-l-4 border-[#e7ff00] pl-6 py-2 text-left md:text-center md:border-none md:pl-0 mx-auto">
            A marketing és az IT összeolvadt. Olyan{" "}
            <span className="text-white font-bold">teljeskörű ökoszisztémákat</span> építünk, amik
            gépként termelik a profitot. Nyers kód, AI-vezérelt ügyfélszolgálat, videós
            tartalomgyártás, adatvezérelt hirdetések és kompromisszummentes projektmenedzsment.
          </p>
      ...
      <div className="relative z-10 w-full overflow-hidden border-y border-white/5 bg-[#050505] py-6 flex items-center mt-8">
        ...
        <div className="flex w-[200%] animate-scroll">
          <div className="flex w-1/2 justify-around items-center opacity-40 font-mono text-xl font-bold tracking-widest uppercase text-[#e7ff00]">
            <span>NEXT.JS</span> <span>•</span> <span>META ADS</span> <span>•</span>{" "}
            <span>OPENAI CHAT</span> <span>•</span> <span>PREMIERE PRO</span> <span>•</span>{" "}
            <span>SUPABASE</span> <span>•</span> <span>TIKTOK ADS</span>
          </div>
          <div className="flex w-1/2 justify-around items-center opacity-40 font-mono text-xl font-bold tracking-widest uppercase text-[#e7ff00]">
            <span>NEXT.JS</span> <span>•</span> <span>META ADS</span> <span>•</span>{" "}
            <span>OPENAI CHAT</span> <span>•</span> <span>PREMIERE PRO</span> <span>•</span>{" "}
      ...
      <section id="services" className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 font-medium text-lg">
            Minden eszköz, amire egy piacvezető vállalatnak szüksége van. Egy helyen.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            className="p-10 rounded-xl bg-[#121212] border-2 border-white/5 hover:border-[#e7ff00]/50 transition-all duration-500 group shadow-2xl relative overflow-hidden animate-float"
          ...
          >
            ...
            <h3 className="text-2xl font-black italic uppercase tracking-tighter text-white mb-4 relative z-10 group-hover:text-[#e7ff00] transition-colors">
              High-End Web & Shop
            </h3>
            <p className="text-gray-400 text-sm font-semibold leading-relaxed relative z-10 tracking-wide">
              Villámgyors vállalati weboldalak és maximális konverzióra optimalizált webáruházak
              Next.js alapokon. Nincs sablon, csak nyers teljesítmény.
            </p>
          </div>
          ...
          >
            ...
            <h3 className="text-2xl font-black italic uppercase tracking-tighter text-white mb-4 relative z-10 group-hover:text-[#00E5FF] transition-colors">
              Performance Marketing
            </h3>
            <p className="text-gray-400 text-sm font-semibold leading-relaxed relative z-10 tracking-wide">
              Adatvezérelt Google, Meta és TikTok kampányok. Nem költjük a pénzed, hanem
              befektetjük. Maximális ROI és folyamatos analitika.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-400 text-sm font-semibold leading-relaxed relative z-10 tracking-wide">
              0-24 órás intelligens ügyfélszolgálat és lead generálás. AI asszisztensek, amik
              válaszolnak és eladnak a weboldaladon, amíg te alszol.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-400 text-sm font-semibold leading-relaxed relative z-10 tracking-wide">
              ...
              Vizuális történetmesélés a legmagasabb minőségben.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-400 text-sm font-semibold leading-relaxed relative z-10 tracking-wide">
              Marketing automatizációk, okos hírlevelek és önjáró blogmotorok. A szoftver dolgozik
              helyetted emberi beavatkozás nélkül.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-400 text-sm font-semibold leading-relaxed relative z-10 tracking-wide">
              Levesszük a terhet a válladról. Teljeskörű IT és marketing projektvezetés a
              legmagasabb nagyvállalati sztenderdek szerint, határidőre.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="packages" className="relative z-10 max-w-7xl mx-auto px-6 py-32 bg-[#0a0a0a]">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 font-medium text-lg">
            Válassz a kőkemény csomagjaink közül, vagy kérj egyedi architektúrát.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#121212] border border-white/10 rounded-2xl p-10 hover:border-white/30 transition-all flex flex-col">
            ...
            <ul className="space-y-4 mb-10 flex-1">
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Prémium Vállalati Weboldal
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Egyedi UI/UX Dizájn
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Villámgyors Next.js alapok
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> SEO felépítés és Copywriting
              </li>
            </ul>
            <Link
          ...
          <div className="bg-gradient-to-b from-[#1a1c00] to-[#121212] border border-[#e7ff00]/50 rounded-2xl p-10 hover:border-[#e7ff00] transition-all transform md:-translate-y-4 shadow-[0_0_30px_rgba(231,255,0,0.15)] flex flex-col relative overflow-hidden">
            ...
            <ul className="space-y-4 mb-10 flex-1">
              ...
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Konverzió-optimalizált Webshop
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Stripe & Barion integráció
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Egyedi admin és Dashboard
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#e7ff00]">✔</span> Meta & Google Ads menedzsment
              </li>
            </ul>
            <Link
              href="/init?csomag=ecommerce"
          ...
          <div className="bg-[#121212] border border-white/10 rounded-2xl p-10 hover:border-[#00E5FF]/40 transition-all flex flex-col relative overflow-hidden group">
            ...
            <h3 className="text-3xl font-black italic uppercase text-white mb-6 relative z-10">
              Full-Stack Ügynökség
            </h3>
            <div className="text-4xl font-black text-white mb-8 border-b border-white/10 pb-8 relative z-10">
              Végtelen <span className="text-lg text-gray-500 font-normal">skálázás</span>
            </div>
            <ul className="space-y-4 mb-10 flex-1 relative z-10">
              <li className="flex items-center gap-3 text-white font-medium text-sm">
                <span className="text-[#00E5FF]">✔</span> Teljes Tech & Marketing lefedettség
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#00E5FF]">✔</span> Hírmotor és Blog automatizáció
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#00E5FF]">✔</span> AI Chatbot ügyfélszolgálat
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#00E5FF]">✔</span> Prémium videó- és tartalomgyártás
              </li>
              <li className="flex items-center gap-3 text-gray-300 font-medium text-sm">
                <span className="text-[#00E5FF]">✔</span> Dedikált IT Projektmenedzser
              </li>
            </ul>
            <Link
              href="/init?csomag=fullstack"
      ...
      <section id="contact" className="relative z-10 w-full px-6 py-32 bg-[#0a0a0a]">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#121212] via-[#0a0a0a] to-[#121212] border-2 border-[#e7ff00]/20 rounded-2xl p-12 md:p-20 text-center shadow-[0_0_50px_rgba(231,255,0,0.1)] relative overflow-hidden group">
          ...
          <p className="text-lg text-gray-400 font-semibold mb-12 max-w-2xl mx-auto relative z-10">
            Ne a versenytársaidat másold. Építs olyan digitális infrastruktúrát, amit ők fognak
            próbálni lemásolni. Bízd ránk a kódolást, a videókat és a hirdetéseket.
          </p>
