      ...
      <footer className="relative z-10 border-t border-white/5 bg-[#050505] py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-xs font-bold text-gray-500 uppercase tracking-widest">
            <Link href="#" className="hover:text-white transition-colors">Arzenál</Link>
            <Link href="#" className="hover:text-white transition-colors">Adatkezelés</Link>
            <Link href="#" className="hover:text-white transition-colors">ÁSZF</Link>
          </div>

          <div className="text-[10px] font-mono text-gray-600 uppercase tracking-widest text-center md:text-right">
            © {new Date().getFullYear()} THE GBR. <br className="md:hidden" />Minden jog fenntartva.
          </div>
        </div>
      </footer>
