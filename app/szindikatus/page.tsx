    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#e7ff00] selection:text-black relative font-sans overflow-hidden">
      ...
      <section className="relative z-10 w-full pt-40 pb-20 px-6 flex flex-col items-center text-center">
        ...
        <p className="max-w-3xl text-gray-400 font-medium text-lg md:text-xl leading-relaxed mb-16 border-l-4 border-[#00E5FF] pl-4 text-left md:text-center md:border-none md:pl-0 mx-auto">
          Nem egy tegnap alakult startup vagyunk, akik a YouTube-ról tanultak kódolni. <strong className="text-white">2002 óta vagyunk a piacon.</strong> Értékesítéssel kezdtük, így pontosan tudjuk, hogy egy weboldalnak nem szépnek kell lennie, hanem eladnia kell.
        </p>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="git-branch space-y-16">
          ...
          <div className="relative pl-16 group">
            ...
            <h3 className="text-2xl font-black italic uppercase text-white mb-3">v1.0 // Az Alapkőletétel</h3>
            <div className="bg-[#121212] border border-white/5 rounded-lg p-6 hover:border-[#e7ff00]/30 transition-colors">
              <p className="text-gray-400 text-sm leading-relaxed font-medium">
                Inicializáltuk a rendszert. Offline és direkt értékesítéssel kezdtük a piacot. Itt tanultuk meg a legfontosabb leckét: a technológia csak egy eszköz, a végső cél mindig az eladás és a profit maximalizálása. Ez a DNS-ünk alapja.
              </p>
            </div>
          </div>
          ...
          <div className="relative pl-16 group">
            ...
            <h3 className="text-2xl font-black italic uppercase text-white mb-3">v2.5 // A Digitális Átállás</h3>
            <div className="bg-[#121212] border border-white/5 rounded-lg p-6 hover:border-[#00E5FF]/30 transition-colors">
              <p className="text-gray-400 text-sm leading-relaxed font-medium">
                A piac megváltozott, és mi vele együtt. Beléptünk a digitális térbe. Az értékesítési tapasztalatunkat adatalapú performance marketing kampányokkal (Meta, Google) és konverzióra kihegyezett landing page-ekkel ötvöztük.
              </p>
            </div>
          </div>
          ...
          <div className="relative pl-16 group">
            ...
            <h3 className="text-2xl font-black italic uppercase text-white mb-3">v4.0 // E-Commerce & Scale</h3>
            <div className="bg-[#121212] border border-white/5 rounded-lg p-6 hover:border-[#9d00ff]/50 transition-colors">
              <p className="text-gray-400 text-sm leading-relaxed font-medium">
                Szintet léptünk. A "szép weboldalak" kora lejárt. Komplett B2B webáruház motorokat, egyedi fizetési integrációkat és CRM rendszereket kezdtünk építeni ügyfeleinknek, hogy automatizáljuk az online növekedésüket.
              </p>
            </div>
          </div>
          ...
          <div className="relative pl-16 group">
            ...
            <div className="font-mono text-[10px] text-[#e7ff00] uppercase tracking-widest mb-1 flex items-center gap-3 font-bold">
              <span className="bg-[#e7ff00]/10 border border-[#e7ff00]/30 px-2 py-1 rounded text-[#e7ff00]">HEAD -&gt; master</span>
              <span>2026 // Jelen</span>
            </div>
            <h3 className="text-3xl font-black italic uppercase text-white mb-3">v5.0 // Full-Stack Szindikátus</h3>
            <div className="bg-gradient-to-br from-[#121212] to-[#0a0a0a] border border-[#e7ff00]/50 rounded-lg p-8 shadow-[0_0_30px_rgba(231,255,0,0.1)]">
              <p className="text-gray-300 text-base leading-relaxed font-medium">
                Létrehoztuk a végső ökoszisztémát. Lépést váltottunk a szűk belső csapatról egy országos, decentralizált szakértői hálózatra. Next.js fejlesztés, AI integráció, videógyártás – bármire is van szükséged, a The GBR hálózata azonnal képes lefedni.
              </p>
            </div>
          </div>
      ...
      <section className="relative z-10 w-full bg-[#050505] border-y border-white/5 py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center opacity-10 pointer-events-none">
          <div className="w-[80vw] h-[80vw] rounded-full border border-[#00E5FF] animate-ping" style={{ animationDuration: '4s' }}></div>
          <div className="absolute w-[60vw] h-[60vw] rounded-full border border-[#e7ff00] animate-ping" style={{ animationDuration: '3s' }}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20 max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 font-medium text-lg md:text-xl leading-relaxed">
              Felejtsd el a kapacitáshiányra panaszkodó kisméretű ügynökségeket. A THE GBR egy kiterjesztett hálózat. <strong className="text-white">Országosan több mint 400 hitelesített szakértő, partner és fejlesztő áll mögöttünk.</strong> Nincs az a technológiai, szoftveres vagy marketing kihívás, amit a mi ökoszisztémánk ne tudna azonnal megoldani.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#121212] border border-white/10 hover:border-[#e7ff00]/50 rounded-xl p-8 transition-colors group">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-black italic uppercase text-white group-hover:text-[#e7ff00] transition-colors">Szakértői Csomópont</h3>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">
                Legyen szó egyedi ERP rendszer fejlesztésről, komplex Next.js API integrációkról, vagy nagy volumenű videós forgatásokról, azonnal tudjuk allokálni az ország legkomolyabb, hitelesített szakembereit az adott feladatra.
              </p>
            </div>
            ...
            <div className="bg-[#121212] border border-white/10 hover:border-[#00E5FF]/50 rounded-xl p-8 transition-colors group">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded bg-[#00E5FF]/10 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#00E5FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                </div>
                <h3 className="text-2xl font-black italic uppercase text-white group-hover:text-[#00E5FF] transition-colors">Végtelen Skálázhatóság</h3>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">
                Mi nem a projektet próbáljuk belezsúfolni az irodánk kereteibe. Mi a csapatot skálázzuk a te projekted igényeihez. Hatalmas büdzsék és agresszív határidők esetén egyszerűen több erőforrást vonunk be a hálózatból.
              </p>
            </div>
            ...
            <div className="bg-[#121212] border border-white/10 hover:border-[#9d00ff]/50 rounded-xl p-8 transition-colors group">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded bg-[#9d00ff]/10 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#9d00ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                </div>
                <h3 className="text-2xl font-black italic uppercase text-white group-hover:text-[#9d00ff] transition-colors">360° Lefedettség</h3>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">
                Nincs olyan, hogy "mi ilyet nem vállalunk". Ha a te B2B ökoszisztémádnak egy speciális AI képfelismerő algoritmusa van szüksége, a THE GBR szindikátusában megtaláljuk és rendszerbe állítjuk az embert, aki lefejleszti.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#121212] to-[#1a1a00] border border-[#e7ff00]/30 hover:border-[#e7ff00] rounded-xl p-8 transition-all shadow-[0_0_20px_rgba(231,255,0,0.05)] group">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded border border-[#e7ff00] bg-[#e7ff00]/10 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#e7ff00]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.956 11.956 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                </div>
                <h3 className="text-2xl font-black italic uppercase text-white group-hover:text-[#e7ff00] transition-colors">Központi Irányítás</h3>
              </div>
              <p className="text-gray-300 text-sm leading-relaxed font-medium">
                Bár a hálózatunk decentralizált, a projektmenedzsment és a minőség-ellenőrzés szigorúan központosított. A THE GBR felelősséget vállal a szállításért. Számodra mi vagyunk az egyetlen kapcsolattartó pont: minden kód és kreatív rajtunk megy keresztül.
              </p>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#121212] border border-white/5 rounded-lg p-8">
            <h4 className="text-xl font-black uppercase text-[#e7ff00] mb-3 border-b border-white/10 pb-3">01. Zéró Bullshit</h4>
            <p className="text-gray-400 text-sm leading-relaxed font-medium">Nem dobálózunk üres marketinges kifejezésekkel. Számokban, KPI-okban és kőkemény adatokban kommunikálunk. Ha valami nem működik, megmondjuk. Ha skálázható, rátoljuk a gázt.</p>
          </div>
          <div className="bg-[#121212] border border-white/5 rounded-lg p-8">
            <h4 className="text-xl font-black uppercase text-[#00E5FF] mb-3 border-b border-white/10 pb-3">02. Nyers Teljesítmény</h4>
            <p className="text-gray-400 text-sm leading-relaxed font-medium">A kódunk patika. A dizájnunk konvertál. A videóink eladnak. Nem elégszünk meg az iparági átlaggal, mi diktáljuk a tempót és a technológiai sztenderdeket a partnereink piacán.</p>
          </div>
          <div className="bg-[#121212] border border-white/5 rounded-lg p-8">
            <h4 className="text-xl font-black uppercase text-[#9d00ff] mb-3 border-b border-white/10 pb-3">03. B2B Fókusz</h4>
            <p className="text-gray-400 text-sm leading-relaxed font-medium">Csak olyan vállalatokkal dolgozunk, akik értik a befektetés és a költség közötti különbséget. Nem vállalunk el mindent: csak ott építünk rendszert, ahol garantálni tudjuk a szintlépést.</p>
          </div>
        </div>
      </section>
